...
def get_lower_to_upper_dict():
    ...
    """
    return dict(zip(list(string.ascii_letters.lower()),list(string.ascii_letters.upper())))
...
def get_encoding_dict():
    ...
    """
    return dict(dict(zip(list(string.ascii_letters.lower()),list(range(1,27)))),**(dict(zip(list(string.ascii_letters.upper()),list(range(1,27))))))
...
def capitalize_names(input):
    ...
    """
    return list(map((lambda x: x.title()), input))
...
def bit_count_even(number):
    ...
    """
    return  bin(number)[2:].count('1')%2==0
