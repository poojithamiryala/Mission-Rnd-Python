...
def test_function_call_with_keyword_arguments():
    ...
    assert [10,20,3,4] == demo(second=20,first=10)
    assert [2,20,30,4] == demo(second=20, third=30,first=2)
...
def test_function_with_keyword_args():
    ...
    assert {} == demo_with_keyword_args(name="jack") # what do you observe here?-no keyword arguments
